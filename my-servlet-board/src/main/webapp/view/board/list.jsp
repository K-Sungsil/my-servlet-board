    ...
    <div class="p-2 border-primary mb-3">
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination pagination-sm">
          ...
          %>
            <li class="page-item">
              <a class="page-link" href="/board/list?page=<%=pagination.getStartPageOnScrean()-1%>" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
          <%} else {%>
          ...
          %>
          <li class="page-item">
            <a class="page-link" href="/board/list?page=<%=pagination.getEndPageOnScrean()+1%>">Next</a>
          </li>
          <%} else {%>
          <li class="page-item disabled" >
            <a class="page-link" href="/board/list?page=<%=pagination.getEndPageOnScrean()+1%>">Next</a>
